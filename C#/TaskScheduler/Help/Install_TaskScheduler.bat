...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /mediaBookList "Task Scheduler Managed Class Library 1.5" /productName "Task Scheduler Managed Class Library 1.5" > NUL
...
COPY /Y "TaskScheduler.msha" HelpContentSetup.msha
